...
Stdlib.selectLayers(doc, Stdlib.getLayersList(doc), true);
var desc1 = new ActionDescriptor();
var ref1 = new ActionReference();
...
desc1.putEnumerated(charIDToTypeID('Aply'), stringIDToTypeID('projection'), charIDToTypeID('Auto'));
desc1.putBoolean(stringIDToTypeID('vignette'), false);
desc1.putBoolean(stringIDToTypeID('radialDistort'), false);
executeAction(stringIDToTypeID('align'), desc1, DialogModes.NO);